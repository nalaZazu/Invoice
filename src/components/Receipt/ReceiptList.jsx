                ...
                <li className={receipt.receipt}>
                    <Link to="/receipt" className={receipt.receipt_main}>
                        <div className={receipt.receipt_left}>
                            <p className={receipt.receipt_info}>status
                                <div className={`${receipt.status}`}>
                                    <button type='button' className={`${receipt.type} rounded-lg`}>Paid</button>
                                </div>
                            </p>
                        </div>
                        <div className={receipt.receipt_right}>
                            <div>
                                <button type='button' className={` p-3 rounded-full  ${receipt.edit}`}>Edit  </button>
                            </div>
                            <div className={`${receipt.status} rounded-lg`}>
                                <button type='button' onClick={toggleDelete} className={`bg-red-600 text-white p-3 rounded-full`}>Delete
                                                            ...
                                                            <div className="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                                                                <div className="sm:flex sm:items-start">
                                                                    ...
                                                                    <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                                                                        <Dialog.Title as="h1" className=" font-semibold leading-6 text-2xl text-gray-900">
                                                                            Confirm Deletion
                                                                        </Dialog.Title>
                                                                        <div className="mt-2">
                            ...
                            </div> <div className={`${receipt.status} rounded-lg`}>
                                <button type='button' className={`${receipt.delete} text-white p-3 rounded-full`}>Mark as Paid</button>
                            </div>
                        </div>
                    </Link>
                </li>
            ...
            <div className=" w-3/6 border-solid  bg-white mx-auto  rounded-md pb-5 ">
                ...
                <div className='flex justify-between m-5 pt-3'>
                    ...
                    <div>
                        ...
                        <p className='text-left text-gray-400 text-base'>19 Union Terrace,</p>
                        <p className='text-left text-gray-400 text-base'>London,</p>
                        <p className='text-left text-gray-400 text-base'>E1 3EZ,</p>
                        <p className="text-left text-gray-400 text-base">United Kingdom
                        </p>
                    </div>
                    <div>
                ...
                {/* third div */}
                    ...
                    <div className='flex justify-around rounded-md bg-gray-100 mx-5 pt-5 pb-5'>
                        <div>
                            <p className='text-gray-400 font-bold text-sm text-left'>Item Name</p>
